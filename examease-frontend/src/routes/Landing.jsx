                            ...
                            <div className="mt-20">
                                <div>
                                    <a href="#" className="inline-flex space-x-4">
                                        <span className="rounded bg-indigo-50 px-2.5 py-1 text-sm font-semibold text-indigo-500">
                                            What's new
                                        </span>
                                ...
                                <div className="mt-6 sm:max-w-xl">
                                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                                        ExamEase: An Automated Evaluation System
                                    </h1>
                                ...
                                <div className="mt-6">
                                    <div className="inline-flex items-center divide-x divide-gray-300">
                                        ...
                                        <div className="min-w-0 flex-1 py-1 pl-5 text-sm text-gray-500 sm:py-3">
                                            ...
                                            <span className="font-medium text-indigo-500">500 beta users</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                            ...
                            <div className="relative -mr-40 pl-4 sm:mx-auto sm:max-w-3xl sm:px-0 lg:h-full lg:max-w-none lg:pl-12">
                                <img
                                    ...
                                    src="https://i.ibb.co/t8T0nDL/lol.png"
                                    alt=""
                                />
                            </div>
                        </div>
